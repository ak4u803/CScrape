...
- 🚀 **Multi-Site Support**: Built-in scrapers for Amazon, eBay, Walmart, Target, Best Buy, Newegg, Etsy, and AliExpress
...
- Args: `sites` - list of site names ['amazon', 'ebay', 'walmart', 'target', 'bestbuy', 'newegg', 'etsy', 'aliexpress']
...
│   ├── target_scraper.py   # Target scraper
│   ├── bestbuy_scraper.py  # Best Buy scraper
│   ├── newegg_scraper.py   # Newegg scraper
...
The scraper currently supports **8 e-commerce sites**:
1. **Amazon** - World's largest online marketplace
2. **eBay** - Auction and shopping website
3. **Walmart** - Major retail corporation
4. **Target** - Retail department store
5. **Best Buy** - Electronics specialty store
6. **Newegg** - Computer hardware and electronics
7. **Etsy** - Handmade and vintage items marketplace
8. **AliExpress** - International retail service
...
- More e-commerce sites (Costco, Home Depot, etc.)
